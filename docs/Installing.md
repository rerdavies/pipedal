...
- [Raspberry Pi OS bookworm (aarch64) v2.0.110](https://github.com/rerdavies/pipedal/releases/download/v2.0.110/pipedal_2.0.110_arm64.deb)
- [Ubuntu 24.04 through 25.04 (aarch64) v2.0.110](https://github.com/rerdavies/pipedal/releases/download/v2.0.110/pipedal_2.0.110_arm64.deb)
- [Ubuntu 24.04 through 25.04 (amd64) v2.0.110](https://github.com/rerdavies/pipedal/releases/download/v2.0.110/pipedal_2.0.110_amd64.deb)


Version 2.0.110 has been tested on Raspberry Pi OS bookworm, Ubuntu 24.04 (amd64), Ubuntu 24.10 (aarch64), and Ubuntu 25.04 (aarch64). Download the appropriate package for your platform, and install using the following procedure:
