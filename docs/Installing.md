...
- [Raspberry Pi OS bookworm (64-bit) v1.2.43](https://github.com/rerdavies/pipedal/releases/download/)
...
Version 1.2.43 has not yet been tested on Ubuntu or Raspberry Pi OS bullseye. On these platforms, we recommend that you use version 1.1.31.
...
```
  sudo apt update
  cd ~/Downloads  
  sudo apt-get install pipedal_1.2.43_arm64.deb 
```
