...
- [Raspberry Pi OS bookworm (aarch64) v2.0.109](https://github.com/rerdavies/pipedal/releases/download/v2.0.109/pipedal_2.0.109_arm64.deb)
- [Ubuntu 24.04 through 25.04 (aarch64) v2.0.109](https://github.com/rerdavies/pipedal/releases/download/v2.0.109/pipedal_2.0.109_arm64.deb)
- [Ubuntu 24.04 through 25.04 (amd64) v2.0.109](https://github.com/rerdavies/pipedal/releases/download/v2.0.109/pipedal_2.0.109_amd64.deb)


Version 2.0.109 has been tested on Raspberry Pi OS bookworm, Ubuntu 24.04 (amd64), Ubuntu 24.10 (aarch64), and Ubuntu 25.04 (aarch64). Download the appropriate package for your platform, and install using the following procedure:

```
  sudo apt update
  sudo apt upgrade
  cd ~/Downloads  
  sudo apt-get install ./pipedal_2.0.109_arm64.deb 
```
...
```
scp Downloads/pipedal_2.0.109_arm64.deb username@server_address:/home/username/
```
