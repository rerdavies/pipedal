...
| [DPF Plugins](https://github.com/DISTRHO/DPF-Plugins) ★★★★★   | `sudo apt install dpf-plugins-lv2` | Bit crusher, pitch shift, reverbs, 3-band EQ, interesting experimental effects and more. |
